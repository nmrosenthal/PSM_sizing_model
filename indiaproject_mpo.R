...
analyze = function(approxbool) {
  ...
  return(cbind(results,ratings,rating_symbols))
}
...
ratings = c(0.008,.0048,.057,.0131,0.218,0.404)
...
pdef_psm = function(utility, rating_p, approxbool) {
  ...
  if(security_p > 0 && security_p < 1) {
    ...
    psm_size = monthyl_debt_service*s
    return(s)
  }
  else {
